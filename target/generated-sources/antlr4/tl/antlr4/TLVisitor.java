...
public interface TLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link TLParser#speakStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpeakStatement(TLParser.SpeakStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitErrorExpression(TLParser.ErrorExpressionContext ctx);
	/**
